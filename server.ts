...
import { INITIAL_DESTINATIONS, INITIAL_ESTABLISHMENTS, INITIAL_OFFERS, INITIAL_REVIEWS } from './src/data';
import { User, Establishment, Offer, Booking, Review, ItineraryRequest, SenegalDestination } from './src/types';
  ...
  const defaultUsers: User[] = [
    {
      ...
      password: 'tourist', // simple plain text password for MVP ease
      name: 'Fatou Diop',
      role: 'tourist',
    },
    {
...
app.post('/api/establishments', (req, res) => {
  ...
  // Link the user owner to this establishment
...
app.post('/api/bookings', (req, res) => {
  ...
  // Calculate total price: simple day difference * price
...
app.post('/api/reviews', (req, res) => {
  ...
  // Recalculate average rating of establishment
